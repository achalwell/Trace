    ...
    for ttl in range(1,MAX_HOPS):
        for tries in range(TRIES):
            ...
            try:
                ...
                #Fill in start
                icmpType = recvPacket[20:28]
                icmpHeader, code, mychecksum, packetID, sequence = struct.unpack("bbHHh", icmpType)
                ...
                if type == 11:
                    ...
                    timeSent = struct.unpack("d", recvPacket[20:28 +
                    bytes])[0]
                    #Fill in start
